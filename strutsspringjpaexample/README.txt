...
The data access classes follow the Generic DAO pattern as described here:
http://insidecoding.wordpress.com/2011/09/07/the-generic-dao-pattern-in-java-with-spring-3-and-jpa-2-0/
